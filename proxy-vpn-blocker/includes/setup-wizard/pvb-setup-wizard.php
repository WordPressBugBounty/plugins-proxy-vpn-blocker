...
<div class="wrap" id="<?php $this->parent->_token; ?>_pvb-setup-wizard">
		<?php if ( 'on' === get_option( 'pvb_setup_complete' ) ) : ?>
			<div class="pvberror">
				<div class="pvberrortitle"><?php esc_html_e( 'Oops!', 'proxy-vpn-blocker' ); ?></div>
				<div class="pvberrorinside">
					<h2><?php esc_html_e( 'Proxy & VPN Blocker Setup Wizard was already completed.', 'proxy-vpn-blocker' ); ?></h2>
				</div>
			</div>
		<?php else : ?>
		<div class="pvb-setup-container">
			<h1><?php esc_html_e( 'Proxy & VPN Blocker Setup Wizard', 'proxy-vpn-blocker' ); ?></h1>
